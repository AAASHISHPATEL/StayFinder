...
function ListingPage3() {
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto  relative'>
         ...
         <div className='w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px]'>{`${title} ${category} , ${landmark}`}</div>
         <div className='w-[95%] flex items-start justify-start text-sm italic md:w-[80%]  text-gray-800'>{`${description}`}</div>
